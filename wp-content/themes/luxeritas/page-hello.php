...
<div class="mx-2 mb-2">
<h1>Matching Appとは?</h1>
</div>
<div class="mx-2 mb-2">
<p>オイスターワールド社が開発したBtoC向けマッチングアプリのサンプルです。</p>
<p>WordPressを使えば、短い工期でアプリを開発することができます。</p>
</div>
<div class="mx-2 mb-2">
<h2>機能一覧</h2>
</div>
...
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?page_id=53" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                                ログイン機能
                        </h3>
                        <p class="service_desc">
				アカウントを使用してアプリにログインする機能です。
                        </p>
                </div>
        </a>
</div>
...
<div class="col-md-6 d-flex">
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?page_id=54" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                                ユーザ登録機能
                        </h3>
                        <p class="service_desc">
				ユーザのアカウントを登録します。サービスを受ける側・提供する側で権限を分けられます。
                        </p>
                </div>
        </a>
</div>
...
<div class="col-md-6 d-flex">
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?page_id=178" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                                投稿機能
                        </h3>
                        <p class="service_desc">
				サービス提供者は提供したいサービスを投稿できます。
                        </p>
                </div>
        </a>
</div>
...
<div class="col-md-6 d-flex">
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?post_type=service" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                               予約機能
                        </h3>
                        <p class="service_desc">
                               サービス一覧から受けたいサービスを選んで、カレンダーから予約できます。
                        </p>
                </div>
        </a>
</div>
...
<div class="col-md-6 d-flex">
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?page_id=104" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                               ダイレクトメッセージ
                        </h3>
                        <p class="service_desc">
                               他のユーザにダイレクトメッセージを送れます。
                        </p>
                </div>
        </a>
</div>
...
<div class="col-md-6 d-flex">
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?page_id=453" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                               チャット機能
                        </h3>
                        <p class="service_desc">
                               他のユーザとリアルタイムチャットができます。
                        </p>
                </div>
        </a>
</div>
...
<div class="col-md-6 d-flex">
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?page_id=301" style="text-decoration: none;">
                <div class="card-body">
                        <h3 class="title">
                               お気に入り機能
                        </h3>
                        <p class="service_desc">
                               投稿されているサービスをお気に入り登録できます。
                        </p>
                </div>
        </a>
</div>
...
<div class="service card mb-2 shadow mx-0" style="width:100%;">
        <a href="http://source.oysterworld.jp/matching-app/?post_type=service" style="text-decoration: none;">
                <div class="card-body">
                        ...
                        <p class="service_desc">
                               投稿されているサービスに点数、コメントをつけることができます。
                        </p>
                </div>
        </a>
</div>
...
<h2>オイスターワールド社のホームページ</h2>
<div>
<?php echo do_shortcode('[custom-banner id="9"]') ?>
</div>
