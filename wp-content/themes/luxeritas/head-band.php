...
?>
	<li><span class="snsf line mt-2" onclick="openNotificationModal(<?php echo $unread_count ?>)" id="notification-button">&nbsp;<i class="far fa-bell"></i>&nbsp;<?php if( $luxe['head_band_follow_icon'] === 'icon_name' ) echo "<span class='fname'>{$unread_count}</span>&nbsp;"; ?></span></li>
<?php
